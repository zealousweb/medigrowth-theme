...
<h2 class="wp-block-heading has-xx-large-font-size"><strong><?php echo esc_html_e( 'Dr. Kabir Nair', 'swasthika' ); ?></strong></h2>
<!-- /wp:heading -->

<!-- wp:heading {"level":6,"style":{"elements":{"link":{"color":{"text":"var:preset|color|primary-800"}}}},"textColor":"primary-800","fontSize":"small"} -->
<h6 class="wp-block-heading has-primary-800-color has-text-color has-link-color has-small-font-size"><?php echo esc_html_e( 'Cardiologist', 'swasthika' ); ?></h6>
<!-- /wp:heading -->
...
<li class="has-body-md-font-size" style="margin-bottom:13px;line-height:1.5"><?php echo esc_html_e( 'Gold Medalist with expertise in preventive cardiology and heart health.', 'swasthika' ); ?></li>
<!-- /wp:list-item -->

<!-- wp:list-item {"style":{"spacing":{"margin":{"bottom":"13px"}}},"fontSize":"body-md"} -->
<li class="has-body-md-font-size" style="margin-bottom:13px"><?php echo esc_html_e( 'Experienced heart specialist providing advanced cardiac care and treatments.', 'swasthika' ); ?></li>
<!-- /wp:list-item -->

<!-- wp:list-item {"style":{"spacing":{"margin":{"bottom":"13px"}}},"fontSize":"body-md"} -->
<li class="has-body-md-font-size" style="margin-bottom:13px"><?php echo esc_html_e( 'Expert in diagnosing and treating heart diseases with advanced care.', 'swasthika' ); ?></li>
<!-- /wp:list-item -->

<!-- wp:list-item {"fontSize":"body-md"} -->
<li class="has-body-md-font-size"><?php echo esc_html_e( 'Dedicated to improving heart health through personalized treatment plans.', 'swasthika' ); ?></li>
<!-- /wp:list-item --></ul>
<!-- /wp:list -->
...
<figure class="wp-block-image size-full has-custom-border"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/doctor-profile.avif'; ?>" alt="<?php echo esc_attr_e( 'Doctor Profile', 'swasthika' ); ?>" class="wp-image-39" style="border-radius:24px" /></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div>
