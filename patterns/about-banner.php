 ...
 */
?>
<!-- wp:group {"metadata":{"categories":["medigrowth-fse"],"patternName":"medigrowth/about-banner","name":"About Banner"},"align":"full","className":"about-banner","style":{"spacing":{"blockGap":"0px","margin":{"top":"0px","bottom":"0px"}}},"gradient":"blue-midnight","layout":{"type":"constrained"}} -->
...
<h2 class="wp-block-heading has-xx-large-font-size"><strong><?php echo esc_html_e( 'Dr. Kabir Nair', 'medigrowth' ); ?></strong></h2>
<!-- /wp:heading -->

<!-- wp:heading {"level":6,"style":{"elements":{"link":{"color":{"text":"var:preset|color|primary-800"}}}},"textColor":"primary-800","fontSize":"small"} -->
<h6 class="wp-block-heading has-primary-800-color has-text-color has-link-color has-small-font-size"><?php echo esc_html_e( 'Cardiologist', 'medigrowth' ); ?></h6>
<!-- /wp:heading -->
...
<li class="has-body-md-font-size" style="margin-bottom:13px;line-height:1.5"><?php echo esc_html_e( 'Gold Medalist with expertise in preventive cardiology and heart health.', 'medigrowth' ); ?></li>
<!-- /wp:list-item -->

<!-- wp:list-item {"style":{"spacing":{"margin":{"bottom":"13px"}}},"fontSize":"body-md"} -->
<li class="has-body-md-font-size" style="margin-bottom:13px"><?php echo esc_html_e( 'Experienced heart specialist providing advanced cardiac care and treatments.', 'medigrowth' ); ?></li>
<!-- /wp:list-item -->

<!-- wp:list-item {"style":{"spacing":{"margin":{"bottom":"13px"}}},"fontSize":"body-md"} -->
<li class="has-body-md-font-size" style="margin-bottom:13px"><?php echo esc_html_e( 'Expert in diagnosing and treating heart diseases with advanced care.', 'medigrowth' ); ?></li>
<!-- /wp:list-item -->

<!-- wp:list-item {"fontSize":"body-md"} -->
<li class="has-body-md-font-size"><?php echo esc_html_e( 'Dedicated to improving heart health through personalized treatment plans.', 'medigrowth' ); ?></li>
<!-- /wp:list-item --></ul>
<!-- /wp:list -->
...
<div class="wp-block-button is-style-shadow"><a class="wp-block-button__link wp-element-button"><?php echo esc_html_e( 'Book An Appointment', 'medigrowth' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column -->
...
<figure class="wp-block-image size-full has-custom-border"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/doctor-profile.avif'; ?>" alt="<?php echo esc_attr_e( 'Doctor Profile', 'medigrowth' ); ?>" class="wp-image-39" style="border-radius:24px" /></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div>
