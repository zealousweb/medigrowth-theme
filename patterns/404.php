...
<h1 class="wp-block-heading has-secondary-color has-text-color has-link-color"><?php esc_html_e( '404', 'medigrowth' ); ?></h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"700"},"spacing":{"margin":{"top":"32px","bottom":"32px"}}},"fontSize":"medium"} -->
<p class="has-medium-font-size" style="margin-top:32px;margin-bottom:32px;font-style:normal;font-weight:700"><?php esc_html_e( 'Something went wrong!', 'medigrowth' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button -->
<div class="wp-block-button is-style-shadow"><a class="wp-block-button__link wp-element-button"><?php esc_html_e( 'Back To Home', 'medigrowth' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/404-background.avif'; ?>" alt="<?php esc_attr_e( '404 Background', 'medigrowth' ); ?>" /></figure>
<!-- /wp:image --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></main>
