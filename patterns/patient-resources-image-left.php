...
<figure class="wp-block-image size-full has-custom-border"><img src="https://siteproofs.com/projects/zealousweb/free-theme/swasthika/wp-content/uploads/2025/03/patient-resources-image-left.png" alt="patient-resources-image-left" class="wp-image-272" style="border-radius:24px;aspect-ratio:1;object-fit:cover"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<h2 class="wp-block-heading has-primary-100-color has-text-color has-link-color has-large-font-size" style="margin-bottom:8px">Pre-surgery Care</h2>
<!-- /wp:heading -->
