...
<figure class="wp-block-image size-full is-resized site-logo"><a href="http://192.168.1.81/shared-projects/zealousweb/free-theme/medigrowth"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/header-logo.svg" alt="Header Logo" style="width:220px"/></a></figure>
<!-- /wp:image --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
