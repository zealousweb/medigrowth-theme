...
<figure class="wp-block-image size-full is-resized site-logo"><a href="<?php echo esc_url( home_url() ); ?>"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/header-logo.avif'; ?>" alt="<?php echo esc_attr_e( 'Header Logo', 'medigrowth' ); ?>" style="width:220px" /></a></figure>
<!-- /wp:image --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
