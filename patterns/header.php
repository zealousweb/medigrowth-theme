...
<figure class="wp-block-image size-full is-resized site-logo"><a href="https://demo.zealousweb.com/wordpress-themes/swasthika"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/header-logo.avif" alt="Header Logo" style="width:220px"/></a></figure>
<!-- /wp:image --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
