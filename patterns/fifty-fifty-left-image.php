...
<figure class="wp-block-image size-full has-custom-border"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/doctor-profile.avif'; ?>" alt="<?php echo esc_attr__( 'Doctor Profile', 'swasthika' ); ?>" class="wp-image-24" style="border-radius:24px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
