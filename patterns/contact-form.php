 ...
 */
?>
<!-- wp:group {"metadata":{"categories":["medigrowth-fse"],"patternName":"medigrowth/contact-form","name":"Contact Form"},"align":"full","className":"margin-large ","style":{"spacing":{"margin":{"top":"120px","bottom":"120px"}}},"layout":{"type":"constrained"}} -->
...
<h2 class="wp-block-heading has-large-font-size" style="margin-bottom:16px"><?php echo esc_html_e( 'Let’s Connect', 'medigrowth' ); ?></h2>
<!-- /wp:heading -->
