...
<h2 class="wp-block-heading has-large-font-size" style="margin-bottom:16px"><?php esc_html_e( 'Book Appointment', 'medigrowth' ); ?></h2>
<!-- /wp:heading -->
...
<p class="has-primary-900-color has-text-color has-link-color has-body-xl-font-size" style="margin-bottom:48px"><?php esc_html_e( 'Lorem ipsum dolor sit amet consectetur. Morbi lacus tortor diam rhoncus. Arcu proin aliquam viverra pellentesque morbi nullam pulvinar. Libero ullamcorper.', 'medigrowth' ); ?></p>
<!-- /wp:paragraph -->
...
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/call.avif'; ?>" alt="<?php esc_attr_e( 'Call', 'medigrowth' ); ?>" class="wp-image-204" style="width:48px" /></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/envelope.avif'; ?>" alt="<?php esc_attr_e( 'Envelope', 'medigrowth' ); ?>" class="wp-image-203" style="width:48px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/clock.avif'; ?>" alt="<?php esc_attr_e( 'Clock', 'medigrowth' ); ?>" class="wp-image-101" style="width:48px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/location.avif'; ?>" alt="<?php esc_attr_e( 'Location', 'medigrowth' ); ?>" class="wp-image-205" style="width:48px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
