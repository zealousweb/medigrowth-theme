...
<h1 class="wp-block-heading has-base-color has-text-color has-link-color"><?php echo esc_html_e( 'Personalized Healthcare, Tailored for You', 'swasthika' ); ?></h1>
<!-- /wp:heading -->
...
<p class="has-base-color has-text-color has-link-color has-small-font-size" style="font-style:normal;font-weight:500"><?php echo esc_html_e( 'Bringing quality healthcare to your doorstep with personalized care.', 'swasthika' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button is-style-shadow green"><a class="wp-block-button__link wp-element-button"><?php echo esc_html_e( 'Book An Appointment', 'swasthika' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
...
<figure class="wp-block-image size-full has-custom-border"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/doctor-profile.avif'; ?>" alt="<?php echo esc_attr_e( 'Doctor Profile', 'swasthika' ); ?>" style="border-radius:24px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<div class="wp-block-button is-style-shadow"><a class="wp-block-button__link wp-element-button"><?php echo esc_html_e( 'Book An Appointmnt', 'swasthika' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
...
<h2 class="wp-block-heading has-large-font-size" style="margin-bottom:16px"><?php echo esc_html_e( 'Our Services', 'swasthika' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"400"}},"fontSize":"body-xl"} -->
<p class="has-body-xl-font-size" style="font-style:normal;font-weight:400"><?php echo esc_html_e( 'Lorem ipsum dolor sit amet consectetur. Semper odio turpis rhoncus luctus. Libero nunc sed.', 'swasthika' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<div class="wp-block-button is-style-shadow"><a class="wp-block-button__link wp-element-button"><?php echo esc_html_e( 'View All Services', 'swasthika' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/service-logo-1.avif'; ?>" alt="<?php echo esc_attr_e( 'Heart Health Checkups', 'swasthika' ); ?>" style="object-fit:contain;width:64px;height:64px"/></figure>
<!-- /wp:image -->

<!-- wp:heading {"level":6,"style":{"spacing":{"margin":{"top":"16px"}}},"fontSize":"small"} -->
<h6 class="wp-block-heading has-small-font-size" style="margin-top:16px"><?php echo esc_html_e( 'Heart Health Checkups', 'swasthika' ); ?></h6>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"16px"}}},"fontSize":"body-md"} -->
<p class="has-body-md-font-size" style="margin-top:16px"><?php echo esc_html_e( 'Comprehensive cardiac evaluations, ECG, and stress tests to assess heart function.', 'swasthika' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-group"><!-- wp:image {"width":"64px","height":"64px","scale":"contain","sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/service-logo-2.avif'; ?>" alt="<?php echo esc_attr_e( 'Advanced Cardiac Treatments', 'swasthika' ); ?>" style="object-fit:contain;width:64px;height:64px"/></figure>
<!-- /wp:image -->

<!-- wp:heading {"level":6,"style":{"spacing":{"margin":{"top":"16px"}}},"fontSize":"small"} -->
<h6 class="wp-block-heading has-small-font-size" style="margin-top:16px"><?php echo esc_html_e( 'Advanced Cardiac Treatments', 'swasthika' ); ?></h6>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"16px"}}},"fontSize":"body-md"} -->
<p class="has-body-md-font-size" style="margin-top:16px"><?php echo esc_html_e( 'Specialized care for heart diseases, angioplasty, and heart failure management.', 'swasthika' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:image {"lightbox":{"enabled":false},"width":"40px","height":"40px","scale":"cover","sizeSlug":"full","linkDestination":"custom","align":"right","style":{"spacing":{"margin":{"left":"0","right":"0","top":"75px"}},"border":{"radius":"12px"}}} -->
<figure class="wp-block-image alignright size-full is-resized has-custom-border" style="margin-top:75px;margin-right:0;margin-left:0"><a href="#"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/service-link-2.avif'; ?>" alt="<?php echo esc_attr_e( 'Service Link Icon', 'swasthika' ); ?>" style="border-radius:12px;object-fit:cover;width:40px;height:40px"/></a></figure>
<!-- /wp:image --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<div class="wp-block-group"><!-- wp:image {"width":"64px","height":"64px","scale":"contain","sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/service-logo-3.avif'; ?>" alt="<?php echo esc_attr_e( 'Virtual Consultation', 'swasthika' ); ?>" style="object-fit:contain;width:64px;height:64px"/></figure>
<!-- /wp:image -->

<!-- wp:heading {"level":6,"style":{"spacing":{"margin":{"top":"16px"}}},"fontSize":"small"} -->
<h6 class="wp-block-heading has-small-font-size" style="margin-top:16px"><?php echo esc_html_e( 'Virtual Consultation', 'swasthika' ); ?></h6>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"16px"}}},"fontSize":"body-md"} -->
<p class="has-body-md-font-size" style="margin-top:16px"><?php echo esc_html_e( 'Get expert cardiac advice from the comfort of your home with secure online consultations.', 'swasthika' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:image {"lightbox":{"enabled":false},"width":"40px","height":"40px","scale":"cover","sizeSlug":"full","linkDestination":"custom","align":"right","style":{"spacing":{"margin":{"left":"0","right":"0","top":"75px"}},"border":{"radius":"12px"}}} -->
<figure class="wp-block-image alignright size-full is-resized has-custom-border" style="margin-top:75px;margin-right:0;margin-left:0"><a href="#"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/service-link-3.avif'; ?>" alt="<?php echo esc_attr_e( 'Service Link Icon', 'swasthika' ); ?>" style="border-radius:12px;object-fit:cover;width:40px;height:40px"/></a></figure>
<!-- /wp:image --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
...
<h2 class="wp-block-heading has-large-font-size"><?php echo esc_html_e( 'Patient Reviews', 'swasthika' ); ?></h2>
<!-- /wp:heading -->
...
<p class="has-primary-900-color has-text-color has-link-color has-body-xl-font-size" style="margin-top:16px"><?php echo esc_html_e( 'Lorem ipsum dolor sit amet consectetur. Semper odio turpis rhoncus luctus. Libero nunc sed.', 'swasthika' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<div class="wp-block-buttons"><!-- wp:button {"className":"is-style-shadow"} -->
<div class="wp-block-button is-style-shadow"><a class="wp-block-button__link wp-element-button"><?php echo esc_html_e( 'View All Reviews', 'swasthika' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<figure class="wp-block-image alignleft size-full is-resized has-custom-border is-style-default" style="margin-right:0"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/client-profile.avif'; ?>" alt="<?php echo esc_attr_e( 'Client Profile', 'swasthika' ); ?>" style="border-radius:50%;object-fit:contain;width:60px;height:60px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<p class="has-primary-100-color has-text-color has-link-color has-body-xl-font-size" style="padding-left:16px"><?php esc_html_e( '~John', 'swasthika' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:column -->
...
<figure class="wp-block-image size-full is-resized has-custom-border"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/client-profile.avif'; ?>" alt="<?php echo esc_attr_e( 'Client Profile', 'swasthika' ); ?>" style="border-radius:50%;object-fit:contain;width:60px;height:60px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
