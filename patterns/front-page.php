...
/**
 * Title: front-page
 * Slug: swasthika/front-page
 * Inserter: no
 */
?>
<!-- wp:template-part {"slug":"header","tagName":"header","className":"site-header"} /-->

<!-- wp:group {"metadata":{"categories":["swasthika-patterns"],"patternName":"swasthika/hero-banner","name":"Hero Banner"},"align":"full","className":"padding-large hero-banner","style":{"dimensions":{"minHeight":""},"spacing":{"padding":{"top":"70px","bottom":"70px"}},"background":{"backgroundImage":{"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/hero-banner.avif","id":546,"source":"file","title":"hero-banner"},"backgroundSize":"cover"}},"layout":{"type":"constrained","justifyContent":"center"}} -->
...
<h1 class="wp-block-heading has-base-color has-text-color has-link-color"><?php echo esc_html__( 'Personalized Healthcare, Tailored for You', 'swasthika' ); ?></h1>
<!-- /wp:heading -->
...
<p class="has-base-color has-text-color has-link-color has-small-font-size" style="font-style:normal;font-weight:500"><?php echo esc_html__( 'Bringing quality healthcare to your doorstep with personalized care.', 'swasthika' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button is-style-shadow green"><a class="wp-block-button__link wp-element-button"><?php echo esc_html__( 'Book An Appointment', 'swasthika' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
...
<div class="wp-block-column"><!-- wp:image {"sizeSlug":"full","linkDestination":"none","style":{"border":{"radius":"24px"}}} -->
<figure class="wp-block-image size-full has-custom-border"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/doctor-profile.avif'; ?>" alt="<?php echo esc_attr__( 'Doctor Profile', 'swasthika' ); ?>" style="border-radius:24px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<h2 class="wp-block-heading has-large-font-size"><strong><?php echo esc_html__( 'Dr. Kabir Nair', 'swasthika' ); ?></strong></h2>
<!-- /wp:heading -->
...
<h3 class="wp-block-heading has-primary-800-color has-text-color has-link-color has-small-font-size" style="margin-top:5px;margin-bottom:5px"><?php echo esc_html__( 'Cardiologist', 'swasthika' ); ?></h3>
<!-- /wp:heading -->
...
<li class="has-custom-3-font-size" style="margin-bottom:13px;line-height:1.5"><?php echo esc_html__( 'Gold Medalist with expertise in preventive cardiology and heart health.', 'swasthika' ); ?></li>
<!-- /wp:list-item -->

<!-- wp:list-item {"style":{"spacing":{"margin":{"bottom":"13px"}}}} -->
<li style="margin-bottom:13px"><?php echo esc_html__( 'Experienced heart specialist providing advanced cardiac care and treatments.', 'swasthika' ); ?></li>
<!-- /wp:list-item -->

<!-- wp:list-item {"style":{"spacing":{"margin":{"bottom":"13px"}}}} -->
<li style="margin-bottom:13px"><?php echo esc_html__( 'Expert in diagnosing and treating heart diseases with advanced care.', 'swasthika' ); ?></li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li><?php echo esc_html__( 'Dedicated to improving heart health through personalized treatment plans.', 'swasthika' ); ?></li>
<!-- /wp:list-item --></ul>
<!-- /wp:list -->
...
<div class="wp-block-button is-style-shadow"><a class="wp-block-button__link wp-element-button"><?php echo esc_html__( 'Book An Appointmnt', 'swasthika' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
...
<!-- wp:group {"metadata":{"categories":["swasthika-patterns"],"patternName":"swasthika/our-services","name":"Our Services"},"className":"our-services padding-large","style":{"spacing":{"padding":{"top":"120px","bottom":"120px"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group our-services padding-large" style="padding-top:120px;padding-bottom:120px"><!-- wp:group {"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:columns {"verticalAlignment":"bottom","className":"our-services-cta","style":{"spacing":{"blockGap":{"top":"var:preset|spacing|50","left":"0"}}}} -->
<div class="wp-block-columns are-vertically-aligned-bottom our-services-cta"><!-- wp:column {"verticalAlignment":"bottom"} -->
<div class="wp-block-column is-vertically-aligned-bottom"><!-- wp:heading {"style":{"spacing":{"margin":{"bottom":"16px"}}},"fontSize":"large"} -->
<h2 class="wp-block-heading has-large-font-size" style="margin-bottom:16px"><?php echo esc_html__( 'Our Services', 'swasthika' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"400"}},"fontSize":"body-xl"} -->
<p class="has-body-xl-font-size" style="font-style:normal;font-weight:400"><?php echo esc_html__( 'Lorem ipsum dolor sit amet consectetur. Semper odio turpis rhoncus luctus. Libero nunc sed.', 'swasthika' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<div class="wp-block-button is-style-shadow"><a class="wp-block-button__link wp-element-button"><?php echo esc_html__( 'View All Services', 'swasthika' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->

<!-- wp:columns {"style":{"spacing":{"margin":{"top":"48px","bottom":"0"},"blockGap":{"top":"40px","left":"40px"}}}} -->
<div class="wp-block-columns" style="margin-top:48px;margin-bottom:0"><!-- wp:column {"verticalAlignment":"stretch","width":"","className":"single-service","style":{"spacing":{"padding":{"top":"32px","bottom":"32px","left":"32px","right":"32px"}},"border":{"radius":"24px","width":"5px","color":"#00999A"}},"backgroundColor":"secondary-100","layout":{"type":"default"}} -->
<div class="wp-block-column is-vertically-aligned-stretch single-service has-border-color has-secondary-100-background-color has-background" style="border-color:#00999A;border-width:5px;border-radius:24px;padding-top:32px;padding-right:32px;padding-bottom:32px;padding-left:32px"><!-- wp:group {"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:image {"width":"64px","height":"64px","scale":"contain","sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/service-logo-1.avif'; ?>" alt="<?php echo esc_attr__( 'Heart Health Checkups', 'swasthika' ); ?>" style="object-fit:contain;width:64px;height:64px"/></figure>
<!-- /wp:image -->

<!-- wp:heading {"level":6,"style":{"spacing":{"margin":{"top":"16px"}}},"fontSize":"small"} -->
<h6 class="wp-block-heading has-small-font-size" style="margin-top:16px"><?php echo esc_html__( 'Heart Health Checkups', 'swasthika' ); ?></h6>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"16px"}}},"fontSize":"body-md"} -->
<p class="has-body-md-font-size" style="margin-top:16px"><?php echo esc_html__( 'Comprehensive cardiac evaluations, ECG, and stress tests to assess heart function.', 'swasthika' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:image {"lightbox":{"enabled":false},"width":"40px","height":"40px","scale":"cover","sizeSlug":"full","linkDestination":"custom","align":"right","style":{"spacing":{"margin":{"left":"0","right":"0","top":"75px"}},"border":{"radius":"12px"}}} -->
<figure class="wp-block-image alignright size-full is-resized has-custom-border" style="margin-top:75px;margin-right:0;margin-left:0"><a href="#"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/service-link-1.avif'; ?>" alt="<?php echo esc_attr__( 'Service Link Icon', 'swasthika' ); ?>" style="border-radius:12px;object-fit:cover;width:40px;height:40px"/></a></figure>
<!-- /wp:image --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->

<!-- wp:column {"verticalAlignment":"stretch","width":"","className":"single-service","style":{"spacing":{"padding":{"top":"32px","bottom":"32px","left":"32px","right":"32px"}},"border":{"radius":"24px","width":"5px"}},"backgroundColor":"primary-300","borderColor":"primary-100"} -->
<div class="wp-block-column is-vertically-aligned-stretch single-service has-border-color has-primary-100-border-color has-primary-300-background-color has-background" style="border-width:5px;border-radius:24px;padding-top:32px;padding-right:32px;padding-bottom:32px;padding-left:32px"><!-- wp:group {"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:image {"width":"64px","height":"64px","scale":"contain","sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/service-logo-2.avif'; ?>" alt="<?php echo esc_attr__( 'Advanced Cardiac Treatments', 'swasthika' ); ?>" style="object-fit:contain;width:64px;height:64px"/></figure>
<!-- /wp:image -->

<!-- wp:heading {"level":6,"style":{"spacing":{"margin":{"top":"16px"}}},"fontSize":"small"} -->
<h6 class="wp-block-heading has-small-font-size" style="margin-top:16px"><?php echo esc_html__( 'Advanced Cardiac Treatments', 'swasthika' ); ?></h6>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"16px"}}},"fontSize":"body-md"} -->
<p class="has-body-md-font-size" style="margin-top:16px"><?php echo esc_html__( 'Specialized care for heart diseases, angioplasty, and heart failure management.', 'swasthika' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:image {"lightbox":{"enabled":false},"width":"40px","height":"40px","scale":"cover","sizeSlug":"full","linkDestination":"custom","align":"right","style":{"spacing":{"margin":{"left":"0","right":"0","top":"75px"}},"border":{"radius":"12px"}}} -->
<figure class="wp-block-image alignright size-full is-resized has-custom-border" style="margin-top:75px;margin-right:0;margin-left:0"><a href="#"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/service-link-2.avif'; ?>" alt="<?php echo esc_attr__( 'Service Link Icon', 'swasthika' ); ?>" style="border-radius:12px;object-fit:cover;width:40px;height:40px"/></a></figure>
<!-- /wp:image --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->

<!-- wp:column {"verticalAlignment":"stretch","width":"","className":"single-service","style":{"spacing":{"padding":{"top":"32px","bottom":"32px","left":"32px","right":"32px"}},"border":{"radius":"24px","width":"5px"}},"backgroundColor":"contrast-transparent","borderColor":"contrast"} -->
<div class="wp-block-column is-vertically-aligned-stretch single-service has-border-color has-contrast-border-color has-contrast-transparent-background-color has-background" style="border-width:5px;border-radius:24px;padding-top:32px;padding-right:32px;padding-bottom:32px;padding-left:32px"><!-- wp:group {"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:image {"width":"64px","height":"64px","scale":"contain","sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/service-logo-3.avif'; ?>" alt="<?php echo esc_attr__( 'Virtual Consultation', 'swasthika' ); ?>" style="object-fit:contain;width:64px;height:64px"/></figure>
<!-- /wp:image -->

<!-- wp:heading {"level":6,"style":{"spacing":{"margin":{"top":"16px"}}},"fontSize":"small"} -->
<h6 class="wp-block-heading has-small-font-size" style="margin-top:16px"><?php echo esc_html__( 'Virtual Consultation', 'swasthika' ); ?></h6>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"16px"}}},"fontSize":"body-md"} -->
<p class="has-body-md-font-size" style="margin-top:16px"><?php echo esc_html__( 'Get expert cardiac advice from the comfort of your home with secure online consultations.', 'swasthika' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:image {"lightbox":{"enabled":false},"width":"40px","height":"40px","scale":"cover","sizeSlug":"full","linkDestination":"custom","align":"right","style":{"spacing":{"margin":{"left":"0","right":"0","top":"75px"}},"border":{"radius":"12px"}}} -->
<figure class="wp-block-image alignright size-full is-resized has-custom-border" style="margin-top:75px;margin-right:0;margin-left:0"><a href="#"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/service-link-3.avif'; ?>" alt="<?php echo esc_attr__( 'Service Link Icon', 'swasthika' ); ?>" style="border-radius:12px;object-fit:cover;width:40px;height:40px"/></a></figure>
<!-- /wp:image --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
...
<!-- wp:group {"metadata":{"categories":["swasthika-fse"],"patternName":"swasthika/patient-reviews","name":"Patient Reviews"},"className":"patient-reviews margin-large ","style":{"spacing":{"padding":{"top":"0px","bottom":"0px"},"margin":{"top":"120px","bottom":"120px"}}},"layout":{"type":"constrained"}} -->
...
<h2 class="wp-block-heading has-large-font-size"><?php echo esc_html__( 'Patient Reviews', 'swasthika' ); ?></h2>
<!-- /wp:heading -->
...
<p class="has-primary-900-color has-text-color has-link-color has-body-xl-font-size" style="margin-top:16px"><?php echo esc_html__( 'Lorem ipsum dolor sit amet consectetur. Semper odio turpis rhoncus luctus. Libero nunc sed.', 'swasthika' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<div class="wp-block-buttons"><!-- wp:button {"className":"is-style-shadow"} -->
<div class="wp-block-button is-style-shadow"><a class="wp-block-button__link wp-element-button"><?php echo esc_html__( 'View All Reviews', 'swasthika' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<p class="has-primary-800-color has-text-color has-link-color has-body-l-font-size" style="line-height:1.55"><img class="wp-image-26" style="width: 30px" src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/double-quotes.avif'; ?>" alt="<?php echo esc_attr__( 'Double Quotes', 'swasthika' ); ?>"><?php echo esc_html__( 'Lorem ipsum dolor sit amet consectetur. At ac tincidunt odio condimentum et non aliquam habitant. Varius elementum ornare a mollis. Ut tempor tortor vel dis vitae. Dictum auctor vulputate gravida ut odio amet ut mattis enim.', 'swasthika' ); ?></p>
...
<figure class="wp-block-image alignleft size-full is-resized has-custom-border is-style-default" style="margin-right:0"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/client-profile.avif'; ?>" alt="<?php echo esc_attr__( 'Client Profile', 'swasthika' ); ?>" style="border-radius:50%;object-fit:contain;width:60px;height:60px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<figure class="wp-block-image size-full is-resized has-custom-border"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/client-profile.avif'; ?>" alt="<?php echo esc_attr__( 'Client Profile', 'swasthika' ); ?>" style="border-radius:50%;object-fit:contain;width:60px;height:60px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<!-- wp:group {"metadata":{"categories":["swasthika-fse"],"patternName":"swasthika/blog-highlights","name":"Blog Highlights"},"align":"full","className":"blog-highlight","layout":{"type":"constrained"}} -->
