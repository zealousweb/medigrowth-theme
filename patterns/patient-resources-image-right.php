 ...
 * Slug: swasthika/patient-resources-image-right
...
<h2 class="wp-block-heading has-primary-100-color has-text-color has-link-color has-large-font-size" style="margin-bottom:8px"><?php echo esc_html_e( 'Post-surgery Care', 'swasthika' ); ?></h2>
<!-- /wp:heading -->
...
<figure class="wp-block-image size-full has-custom-border"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/patient-resources-image-right.avif'; ?>" alt="<?php echo esc_html_e( 'Patient Resources Image Right', 'swasthika' ); ?>" class="wp-image-282" style="border-radius:24px;aspect-ratio:1;object-fit:cover"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
