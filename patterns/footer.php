...
<figure class="wp-block-image aligncenter size-full"><a href="<?php echo esc_url( home_url() ); ?>"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/footer-logo.avif'; ?>" alt="<?php echo esc_attr_e( 'Footer Logo', 'swasthika' ); ?>" /></a></figure>
<!-- /wp:image -->
...
<h6 class="wp-block-heading has-text-align-center has-base-color has-text-color has-link-color" style="margin-top:var(--wp--preset--spacing--40);margin-bottom:var(--wp--preset--spacing--40)"><?php echo esc_html_e( 'Lorem ipsum dolor sit amet consectetur. Id sed diam venenatis pharetra luctus eu.', 'swasthika' ); ?></h6>
<!-- /wp:heading -->
