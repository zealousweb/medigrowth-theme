...
<figure class="wp-block-image aligncenter size-full"><a href="https://demo.zealousweb.com/wordpress-themes/swasthika"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/footer-logo.avif" alt="Footer Logo"/></a></figure>
<!-- /wp:image -->
...
<p class="has-text-align-center has-base-color has-text-color has-link-color has-body-md-font-size" style="padding-top:40px">Swasthika © 2025. All Rights Reserved.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->