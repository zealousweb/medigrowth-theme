 ...
 */
?>
<!-- wp:group {"metadata":{"categories":["swasthika-patterns"],"patternName":"swasthika/hero-banner","name":"Hero Banner"},"align":"full","className":"padding-large hero-banner","style":{"dimensions":{"minHeight":""},"spacing":{"padding":{"top":"70px","bottom":"70px"}},"background":{"backgroundImage":{"url":"<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/hero-banner.avif'; ?>","id":546,"source":"file","title":"hero-banner"},"backgroundSize":"cover"}},"layout":{"type":"constrained","justifyContent":"center"}} -->
